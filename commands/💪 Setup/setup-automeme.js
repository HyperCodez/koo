  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      tempmsg = await message.reply(new Discord.MessageEmbed()
        .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-automeme"]["variable1"]))
        .setColor(es.color)
        .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-automeme"]["variable2"])).setFooter(es.footertext, es.footericon)
      )
      ...
      try {
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-automeme"]["variable3"]))
      ...
      if (timeouterror)
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-automeme"]["variable4"]))
          .setColor(es.wrongcolor)
      ...
      if (timeouterror)
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-automeme"]["variable11"]))
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
        );
      }
