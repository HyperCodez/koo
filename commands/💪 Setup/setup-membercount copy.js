  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      tempmsg = await message.reply(new Discord.MessageEmbed()
        .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-membercount copy"]["variable1"]))
        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
        .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-membercount copy"]["variable2"])).setFooter(es.footertext, es.footericon)
      )
      ...
      try {
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-membercount copy"]["variable3"]))
          .setColor(es.wrongcolor)
          .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-membercount copy"]["variable16"]).substr(0, 2000))
      ...
      if (timeouterror)
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-membercount copy"]["variable4"]))
          .setColor(es.wrongcolor)
      ...
      if(temptype == "toggle"){
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-membercount copy"]["variable5"]))
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
...
*Send the Name NOW!, mind that the Name must be shorter then 32 Characters!!!*`).setFooter(es.footertext, es.footericon)
      ...
      if (timeouterror)
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-membercount copy"]["variable13"]))
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
...
**Cooldown:** Updating the Channels every \`10 Minutes\` with a 2min Delay between each one!`.substr(0, 2048))
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-membercount copy"]["variable14"]))
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
        );
      }
