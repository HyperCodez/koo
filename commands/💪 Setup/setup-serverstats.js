  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      tempmsg = await message.reply(new Discord.MessageEmbed()
        .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-serverstats"]["variable1"]))
        .setColor(es.color)
        .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-serverstats"]["variable2"])).setFooter(es.footertext, es.footericon)
      )
      ...
      try {
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-serverstats"]["variable3"]))
      ...
      if (timeouterror)
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-serverstats"]["variable4"]))
          .setColor(es.wrongcolor)
      ...
      if(temptype == "toggle"){
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-serverstats"]["variable5"]))
          .setColor(es.color)
        ...
        .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-serverstats"]["variable6"]))
        .setColor(es.color)
        .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-serverstats"]["variable7"])).setFooter(es.footertext, es.footericon)
        })
        ...
        .then(async collected => {
          ...
          if(channel){
            ...
            message.reply(new Discord.MessageEmbed()
              .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-serverstats"]["variable8"]))
              .setColor(es.color)
            ...
            tempmsg = await message.reply({embed: new Discord.MessageEmbed()
              .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-serverstats"]["variable9"]))
              .setColor(es.color)
...
*Send the Name NOW!, mind that the Name must be shorter then 32 Characters!!!*`).setFooter(es.footertext, es.footericon)
              ...
              .then(async collected => {
                ...
                if(name && name.length <= 32){
                  ...
                  return message.reply(new Discord.MessageEmbed()
                    .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-serverstats"]["variable10"]))
                    .setColor(es.color)
            ...
            if (timeouterror)
              return message.reply(new Discord.MessageEmbed()
                .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-serverstats"]["variable11"]))
                .setColor(es.wrongcolor)
                .setDescription(`Cancelled the Operation!`.substr(0, 2000))
                .setFooter(es.footertext, es.footericon)
              );
      ...
      if (timeouterror)
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-serverstats"]["variable12"]))
          .setColor(es.wrongcolor)
          .setDescription(`Cancelled the Operation!`.substr(0, 2000))
          .setFooter(es.footertext, es.footericon)
        );
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-serverstats"]["variable13"]))
          .setColor(es.color)
...
**Cooldown:** Updating the Channels every \`10 Minutes\` with a 2min Delay between each one!`.substr(0, 2048))
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-serverstats"]["variable14"]))
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
        );
      }
      ...
      return message.reply(new MessageEmbed()
        ...
        .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-serverstats"]["variable15"]))
      );
    }
  },
};
