    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor('Warn Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/prohibited_1f6ab.png', 'https://discord.gg/sngXqWK2eP')
        ...
        switch (menuoptionindex) {
          ...
          case 1:
              var msg7 = new MessageEmbed()
                ...
                .setFooter(es.footertext, es.footericon)
                .setColor(es.color)
              message.reply({embed: msg7}).then(msg => {
                msg.channel.awaitMessages(m => m.author.id == cmduser, {
                  max: 1,
                  time: 180000,
                  errors: ['time'],
          ...
          case 2:
              var msg8 = new MessageEmbed()
                ...
                .setFooter(es.footertext, es.footericon)
                .setColor(es.color)
              message.reply({embed: msg8}).then(msg => {
                msg.channel.awaitMessages(m => m.author.id == cmduser, {
                  max: 1,
                  time: 180000,
                  errors: ['time'],
          ...
          case 3:
              ...
              message.reply({embed: msg8}).then(msg => {
                msg.channel.awaitMessages(m => m.author.id == cmduser, {
                  ...
                  console.log({ warncount: yeee.warncount, roleid: yeee.roleid })
          ...
          case 4:
            var rembed = new MessageEmbed()
              ...
              message.reply({embed: rembed}).catch(error => {
                  console.log(error)
                return message.reply(new Discord.MessageEmbed()
