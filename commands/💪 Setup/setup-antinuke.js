...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    if(message.author.id != message.guild.ownerID && message.author.id != "442355791412854784"){
      return message.reply(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable1"]))
    }
    ;
    ...
    try {
      ...
      async function first_layer(){
        ...
        .setColor(es.color)
        .setAuthor('Anti Nuke Setup', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/sngXqWK2eP')
        ...
        async function menuselection(menu) {
          if(menu.values[0] == "Cancel") return menu.reply(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable4"]))
          used1 = true;
          if(menu.values[0] == "Information"){
            
            await message.reply("<a:yes:833101995723194437> **The Current Anti-Nuke Settings**",{ content: "<a:yes:833101995723194437> **The Current Anti-Nuke Settings**", embed: new MessageEmbed()
              .setColor(es.color)
              ...
              .addField(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variablex_14"]), eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable11"]))
            ...
            return menu.reply({embed: new MessageEmbed()
            .setColor(es.color)
            .setFooter(es.footertext, es.footericon)
            ...
            let MenuEmbed = new Discord.MessageEmbed()
            .setColor(es.color)
            .setAuthor('Anti Nuke Settings', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/sngXqWK2eP')
            ...
            async function menuselection2(menu) {
              if(menu.values[0] == "Cancel") return menu.reply(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable17"]))
              used1 = true;
              ...
              if(String(index) == "0"){
                ...
                return menu.reply(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable60"]));
              }
            }
            //Event
            client.on('clickMenu', (menu) => {
              ...
              //function to handle the menuselection
              async function menuselection2(menu) {
                if(menu.values[0] == "Cancel") return menu.reply(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable63"]))
                used1 = true;
                let index = menuoptions.findIndex(v=>v.value == menu.values[0])
                //Toggle
                if(String(index) == "0"){
                  client.Anti_Nuke_System.set(message.guild.id, !client.Anti_Nuke_System.get(message.guild.id, "all.enabled"), "all.enabled")
                  return menu.reply(new MessageEmbed()
                  ...
                  .addField(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variablex_66"]), eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable66"]))
                );
                } else if(String(index) == "1"){
                  menu.deferUpdate();
                  let timeouterror = false;
                  ...
                  .addField(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variablex_75"]), eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable75"]))
                );
                } else if(String(index) == "3"){
                  menu.deferUpdate();
                  let timeouterror = false;
                  ...
                  return menu.reply(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable81"]));
                }
              }
              //Event
              client.on('clickMenu', (menu) => {
            ...
            if(!role || role.length <= 5){
              return menu.reply(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable92"]))
            }
            ...
            if(!channels || channels.size == 0){
              return menu.reply(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable93"]))
            }
            menu.reply(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable94"]))
            for(const ch of channels.array()){
              try {
                if(ch) {
            ...
            message.reply(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable95"]));
          } else {
            menu.deferUpdate();
          }
        }
