  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      tempmsg = await message.reply(new Discord.MessageEmbed()
        .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-aichat"]["variable1"]))
        .setColor(es.color)
        .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-aichat"]["variable2"])).setFooter(es.footertext, es.footericon)
      )
      ...
      try {
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-aichat"]["variable3"]))
          .setColor(es.wrongcolor)
          .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-aichat"]["variable12"]).substr(0, 2000))
      ...
      if (timeouterror)
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-aichat"]["variable4"]))
          .setColor(es.wrongcolor)
      ...
      if (timeouterror)
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-aichat"]["variable11"]))
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
        );
      }
