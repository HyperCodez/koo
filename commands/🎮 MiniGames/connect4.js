...
class Connect4 {
    ...
    newGame(msg) {
        ...
        const embed = new Discord.MessageEmbed()
            .setColor("#2f3136")
            .setTitle(eval(client.la[ls]["cmds"]["minigames"]["connect4"]["variable1"]))
            .setDescription(this.gameBoardToString())
            .addField(this.getChipFromTurn()+'\'s Turn:', "\u200b")

            const temEmbed = new Discord.MessageEmbed()
            .setColor("#2f3136")
            .setDescription(eval(client.la[ls]["cmds"]["minigames"]["connect4"]["variable2"]))
            .setTimestamp();
    ...
    step() {
        ...
        const editEmbed = new Discord.MessageEmbed()
            .setColor("#2f3136")
            .setTitle(eval(client.la[ls]["cmds"]["minigames"]["connect4"]["variable3"]))
            .setDescription(this.gameBoardToString())
            .addField(this.getChipFromTurn()+'`\'s Turn:', "\u200b")
    ...
    gameOver(winner) {
        ...
        const editEmbed = new Discord.MessageEmbed()
            .setColor('RED')
            .setTitle(eval(client.la[ls]["cmds"]["minigames"]["connect4"]["variable4"]))
