...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      let tempmsg = await message.reply(new Discord.MessageEmbed().setColor(es.color)
        .setAuthor(client.la[ls].cmds.info.youtubeinfo.loading, "https://cdn.discordapp.com/emojis/756773010123522058.gif", "https://discord.gg/sngXqWK2eP"))
      let button_back = new MessageButton().setStyle('blurple').setCustomId('1').setLabel("<< Back")
      let button_forward = new MessageButton().setStyle('blurple').setCustomId('3').setLabel('Forward >>')
